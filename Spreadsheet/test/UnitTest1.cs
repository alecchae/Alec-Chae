...
///   nor place them in any online respository.  Improper use of these test cases
...
namespace FormulaEvaluator
{
    ...
    ///</summary>
    [TestClass]
    public class AssignmentOneGradingTests
    {
        ...
        {
            Assert.AreEqual(-10, Evaluator.Evaluate("-(5+5)", s => 0));
        }
